...
Forthcoming
-----------
* Merge branch 'fix_beyond_saturation_limits_case' into 'erbium-devel'
  Fix beyond saturation limits case
  See merge request control/ros_control!15
* Merge branch 'fix_beyond_saturation_limits_case' of gitlab:control/ros_control into fix_beyond_saturation_limits_case
* added it as rosted for the newly added throttle and fix the tests for our usecase
* apply review suggestions
* added a limit to the joint velocities when the joint is beyond the soft limits
* reduce the gain by 50 to avoid jerks at the startup of the robot
* separate the k_position gain to a separate variable
* Contributors: Jordan Palacios, Sai Kishor Kothakota
